...
// var databaseUrl = "bulletin";
// var collections = ["evets"];
...
//   db.evets.find({}, function(err, found) {
...
//   db.events.find().sort({ name: 1 }, function(err, found) {
//     // Log any errors if the server encounters one
//     if (err) {
//       console.log(err);
//     }
...
//   db.events.find().sort({ weight: -1 }, function(err, found) {
//     // Log any errors if the server encounters one
//     if (err) {
//       console.log(err);
//     }
